...
import {postToInstagram, storeInDB, getFromMemory, searchImagesTool, showInstaCalendar, calculator_tool } from "./custom-tools.js";
...
const tools = [searchImagesTool, postToInstagram, storeInDB, getFromMemory, showInstaCalendar, calculator_tool];
...
const response = async (text) => {
    ...
    const res = await agent.invoke({
        ...
        // const toolMessage = res.messages.find(msg => msg.name === "calculator" && msg.tool_call_id);
